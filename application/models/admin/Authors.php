...
class Authors extends CI_Model{
     ...
     public function getAuthors(){
          $query = $this->db->query("SELECT a.*,b.email FROM profile_master a join login_master b on a.uid = b.uid where user_type='0' and b.is_active='1'");
     ...
     public function getAutherInfo($param){
