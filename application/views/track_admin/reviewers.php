      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Total Reviewers</h3>
            <small><?php echo '('.(isset($data['msg']))?'0':(count($data)).')';?></small>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
               <script>
               ...
               switch(urlPart){
                    case 'updated':
                         document.write('<div class="callout callout-success"><p>Reviewer has been Updated..!</p></div>')
                         break;
                    case 'deleted':
                         document.write('<div class="callout callout-success"><p>Reviewer has been Deleted..!</p></div>')
                         break;
               }
               </script>
                  ...
                  if(!isset($data['msg'])){
                    foreach ($data as $key => $value) { ?>
                      <tr>
                        ...
                        <td><a href="reviewers_edit/<?php echo $value['id'];?>">Edit</a> | <a href="reviewers_delete/<?php echo $value['id'];?>" class='delete_record'>Delete</a></td>
                      <tr>
                    <?php }
                  }
                ?>
