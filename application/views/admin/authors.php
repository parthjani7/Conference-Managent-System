      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
               ...
               if(urlPart=="deleted"){
                    document.write('<div class="callout callout-success"><p>Author has been Deleted..!</p></div>');
               }
               </script>
                  ...
                  if(!isset($data['msg'])){
                    foreach ($data as $key => $value) { ?>
                      <tr>
                        ...
                        <td><a href="authors_delete/<?php echo $value['id'];?>" class="delete_record">Delete</a></td>
                      <tr>
                    <?php }
                  }
                ?>
