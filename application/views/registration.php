...
<div class="register-box ">
  <div class="register-logo">
       <?php if(isset($param)){?>
           <h2 class="text-primary"><b>Registration for Conference <?php echo strtoupper($param); ?></b></h2>
      <?php } ?>
  </div>

  <div class="register-box-body">
  <p class="text-danger text-center"><strong><?php if(isset($error)){echo $error; }?></strong></p>
    <p class="login-box-msg">Register a new membership or <a class="Link" href="<?php echo base_url().$param.'/login';?>">Login</a></p>
	<form action="registration" method="post">
	  ...
	  <div class="form-group">
		<input type="radio" name="gender" class="minimal" value='0' checked>Male
        <input type="radio" name="gender" class="minimal" value='1'>Female
      </div>
